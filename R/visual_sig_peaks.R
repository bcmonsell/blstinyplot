...
#'        on a single time series. This entry is required.
#' @param spec_type Character string; type of spectrum. Possible values are 
#'        \code{'ori'}, \code{'irr'}, \code{'rsd'}, \code{'sa'}, \code{'comp'}, 
#'        \code{'indsa'}, \code{'indirr'}, \code{'extrsd'}. 
#'        Default is \code{'sa'}.
#' @param spec_freq_code Character string; type of frequency being tested. 
#'        Possible values are \code{'seas'} or \code{'td'}. 
#'        Default is \code{'seas'}.
#' @return If visually significant peaks found, a numeric vector of the 
#'         position of the peak frequecies. If no peaks found, 0 is returned.
#' @examples
#' air_seas <- 
...
#'        x11='')
#' vp_ori_seas <- 
#'    visual_sig_peaks(air_seas, spec_type = 'ori')
#' vp_ori_td   <- 
#'    visual_sig_peaks(air_seas, 
#'       spec_type = 'sa',
#'       spec_freq_code = 'td')
#' @export
visual_sig_peaks <- 
